...
/*if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page(__('Theme Options', HS_CURRENT_THEME), __('Theme Options', HS_CURRENT_THEME), 'edit_theme_options', 'options-framework','optionsframework_page');
...
function optionsframework_load_styles() {
	...
	wp_enqueue_style('icheck', OPTIONS_FRAMEWORK_DIRECTORY.'css/square/grey.css');
...
function optionsframework_load_scripts() {
	...
	wp_enqueue_script('icheckjs', OPTIONS_FRAMEWORK_DIRECTORY.'js/icheck.min.js', array('jquery'));
...
$my_theme_version = wp_get_theme();
			?></h1>
			<span>Administration Panel<?php echo " | version " . $my_theme_version->get( 'Version' ); ?></span>
		</div>
		<div class="clear"></div>
    ...
    <div style="float:left;" id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit-top">
				<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', HS_CURRENT_THEME ); ?>" />
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', HS_CURRENT_THEME ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', HS_CURRENT_THEME ) ); ?>' );" />
				<div class="clear"></div>
			</div>
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', HS_CURRENT_THEME ), 'updated fade' );
	 ...
	 */
		...
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', HS_CURRENT_THEME ), 'updated fade' );
		return $clean;
	}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Theme Options', HS_CURRENT_THEME ),
