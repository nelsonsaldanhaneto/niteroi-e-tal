...
function optionsframework_tabs() {
	...
	$icon = '';
		...
		if ($value['type'] == "heading") {
			...
			$menu .= '<li><a id="'.  esc_attr( $jquery_click_hook ) . '-tab" class="nav-tab" title="' . esc_attr( $value['name'] ) . '" href="' . esc_attr( '#'.  $jquery_click_hook ) . '"><i class="'.$icon.'"></i>' . esc_html( $value['name'] ) . '</a></li>';
		}
	}
